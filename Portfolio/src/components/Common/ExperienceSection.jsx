...
const experiences = [
  {
    ...
    description:
      "Developed responsive web applications using React and TailwindCSS, collaborating with a team to deliver user-friendly interfaces. Implemented animations with Framer Motion to enhance user experience.",
  },
  {
    id: 2,
    ...
    description:
      "Built and maintained client websites using modern JavaScript frameworks. Focused on creating scalable, performant, and visually appealing solutions tailored to client needs.",
  },
];
...
const ExperienceSection = () => {
  return (
    ...
    >
      ...
      >
        <div className="flex flex-col items-center mt-[100px]"  style={{userSelect:'none',WebkitUserSelect:'none',MozUserSelect:'none',msUserSelect:'none'}}>
